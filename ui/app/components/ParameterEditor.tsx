...
const PERCENT_FIELDS = [
  { key: 'spacingPercent', label: 'Rung spacing', hint: 'Distance between rungs' },
  {
    key: 'takeProfitPercent',
    label: 'Take profit',
    hint: "Each lot's own target, from its own fill",
  },
  { key: 'sizePerRung', label: 'Size per rung', hint: 'Fraction of symbol capital' },
